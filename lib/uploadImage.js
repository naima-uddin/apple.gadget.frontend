...
export async function uploadImageDirect(file, folder = "appleProduct/products", options = {}) {
...
export async function uploadAdminImage(file, folder = "appleProduct/products") {
...
export async function uploadUserImage(file, folder = "appleProduct/profiles") {
