  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <button
          onClick={openNew}
          className="flex items-center gap-2 px-4 py-2 bg-violet-700 text-white rounded-lg hover:bg-violet-800 text-sm font-medium shrink-0"
        >
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6 space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            <button
              onClick={handleSave}
              disabled={saving}
              className="px-5 py-2 bg-violet-700 text-white rounded-lg hover:bg-violet-800 text-sm font-medium disabled:opacity-60"
            >
              {saving ? "Saving…" : "Save"}
            </button>
            <button
