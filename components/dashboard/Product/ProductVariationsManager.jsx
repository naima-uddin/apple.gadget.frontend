            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-[20rem_minmax(0,1fr)_auto] md:items-start">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 px-4 py-2.5 outline-none focus:ring-2 focus:ring-gray-500"
                  placeholder="Style"
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  className="min-h-24 w-full rounded-lg border border-gray-300 px-4 py-2.5 outline-none focus:ring-2 focus:ring-gray-500"
              ...
              <button
                type="submit"
                disabled={saving}
                className="rounded-lg bg-gray-800 px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#1D1D1F] disabled:opacity-60 md:mt-7"
              >
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 px-5 py-4">
            ...
            <input
              ...
              className="w-64 rounded-lg border border-gray-300 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-gray-500"
              placeholder="Search"
            />
          </div>
