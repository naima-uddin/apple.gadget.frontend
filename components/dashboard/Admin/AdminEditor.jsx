...
function GroupCheckbox({ allChecked, someChecked, onChange }) {
  ...
  return (
    <input
      ...
      checked={allChecked}
      onChange={onChange}
      className="h-4 w-4 rounded-lg border-gray-300 text-gray-800 accent-gray-800"
    />
  );
}
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-2 border border-gray-300 text-gray-800 rounded-lg text-sm hover:bg-gray-50 whitespace-nowrap font-medium"
