  ...
  const handleReviewImageUpload = async (files) => {
    ...
    try {
      ...
      const assets = await Promise.all(
        selected.map((f) => uploadUserImage(f, "appleProduct/reviews")),
      );
            ...
            <div className="animate-fadeIn">
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-[#1D1D1F] hover:bg-black text-white text-xs font-semibold px-4 py-2 rounded-lg transition"
                >
                  <svg
                    ...
                    >
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="bg-[#1D1D1F] text-white text-sm py-2 px-6 rounded-lg hover:bg-black transition disabled:opacity-60"
                        >
                          {reviewSubmitting
                            ? "Saving…"
                            : editingIndex !== null
                  ...
                  {[...faqs]
                    ...
                    .map((faq) => {
                      ...
                      return (
                        ...
                        >
                          {/* Question */}
                          <div className="flex items-start gap-3 p-4 border-l-4 border-[#1D1D1F] bg-white">
                            <div className="flex-shrink-0 w-7 h-7 rounded-full bg-[#1D1D1F] flex items-center justify-center text-white font-bold text-xs mt-0.5">
                              Q
                            </div>
                            <div className="flex-1 min-w-0">
                                        ...
                                        >
                                          ...
                                          <div className="flex gap-2">
                                            <button
                                              ...
                                              className="text-xs px-3 py-1.5 rounded-lg bg-[#1D1D1F] text-white hover:bg-black disabled:opacity-60 font-medium"
                                            >
                                              {aForm.submitting
                                                ? "Saving…"
                                                : "Update"}
                                ...
                                >
                                  ...
                                  <div className="flex gap-2">
                                    <button
                                      type="submit"
                                      disabled={aForm.submitting}
                                      className="text-xs px-4 py-1.5 rounded-lg bg-[#1D1D1F] text-white hover:bg-black disabled:opacity-60 font-medium transition"
                                    >
                                      {aForm.submitting
                                        ? "Submitting…"
                                        : "Submit Answer"}
