...
// ─────────────────────────────────────────────────────────────────────────────
// BannerClassic
// The ORIGINAL homepage banner design, kept fully self-contained so it can be
// reused anywhere (drop <BannerClassic /> into any page). It reads the same
// /api/banners data source. The homepage now uses the new <Banner /> (two side
// images + centred text + glassy button); this classic version is preserved
// unchanged for reuse.
// ─────────────────────────────────────────────────────────────────────────────
