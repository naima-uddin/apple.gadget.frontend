    ...
    >
      ...
      {showArrows && (
        <button
          onClick={prev}
          aria-label="Previous"
          className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-3 z-10 w-9 h-9 rounded-full bg-white shadow-md border border-gray-200 flex items-center justify-center text-gray-600 hover:border hover:border-[#1D1D1F] transition-colors"
        >
          <svg
            className="w-4 h-4"
            fill="none"
      ...
      {showArrows && (
        <button
          onClick={next}
          aria-label="Next"
          className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-3 z-10 w-9 h-9 rounded-full bg-white shadow-md border border-gray-200 flex items-center justify-center text-gray-600 hover:border hover:border-[#1D1D1F] transition-colors"
        >
          <svg
            className="w-4 h-4"
            fill="none"
